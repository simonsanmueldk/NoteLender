...
public class PersistenceServerController {
    ...
    public synchronized String getGroupMembersList(
    ...
    public synchronized String getInvitationList(
    ...
    public synchronized String deleteInvitation(
            @PathVariable(value = "id") String id) {
        return persistenceService.deleteInvitation(id);
    }

    @PostMapping("/groupmembers")
    public synchronized String AddGroupMember(@RequestBody String json) {
